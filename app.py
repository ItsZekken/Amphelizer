...
def main():
    ...
    if uploaded_file is not None:
        ...
        activities_df = tags_exploded[tags_exploded['tags'].apply(lambda x: x['type'] if isinstance(x, dict) else None) == 'Actividades']
        emotions_df = tags_exploded[tags_exploded['tags'].apply(lambda x: x['type'] if isinstance(x, dict) else None) == 'Emociones']
